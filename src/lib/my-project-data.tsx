...
const data: ProjectContent[] = [
  ...
  },
  {
    ...
    image: [
      "/assets/my-project/chess1.png",
      "/assets/my-project/chess2.png",
      "/assets/my-project/chess3.png",
      "/assets/my-project/chess4.png",
    ],
    content:
      "지인과 체스를 즐길 수 있는 체스 게임입니다. \n방이름을 입력하여 생성하거나, 이미 만들어진 방에 입장이 가능합니다. \n알람기능을 적용하여 상대방이 입장하거나, 게임 시작, 체스말이 잡힐때, 게임이 끝날때 등 알람을 띄우고 자동으로 사라집니다. \n게임중 누구의 차례인지 시각적으로 확인할 수 있습니다. \n게임이 종료되면 재매치 혹은 방을 나갈수 있습니다.",
    subContent:
      "socket.io를 이용한 체스게임, 체스 알고리즘, 채팅 기능, 알림 기능",
  ...
  },
  {
    ...
    content:
      "비교를 원하는 데이터를 입력하여 그래프를 통해 시각적으로 결과를 확인할 수 있는 프로그램입니다. \n그룹을 이뤄 전체 값을 확인할 수 있고, CSV로 추출이 가능합니다. \nPWA를 사용하여 웹앱으로 사용이 가능합니다.",
    subContent:
      "수를 입력하고 분석, 그래프를 통한 시각적 확인, 그룹별로 비교, CSV추출 가능, PWA적용",
  ...
  },
  {
    ...
    image: [
      "/assets/my-project/moa1.png",
      "/assets/my-project/moa2.png",
      "/assets/my-project/moa3.png",
    ],
    content:
      "개인의 일정 관리 및 지인과 실시간으로 채팅을 치며 계획을 작성할 수 있는 일정관리 서비스입니다. \n실제로 광고를 하며 배포하여 유저 피드백까지 받아 정정한 팀 프로젝트입니다. \n팀 리더를 맡아 FE, BE의 원할한 의사소통을 주재 하였으며, 팀의 전체적인 일정관리 및 기술 적용을 주도하였습니다.",
    subContent:
      "생동적인 모션을 통해 일정확인 가능, 일정에 지도를 통해 장소 저장가능, 그룹일정시 실시간으로 채팅치며 생성가능",
    gitHub: "https://github.com/99-Moa/99-MOA-F.git",
    url: "https://moa99.site (offline)",
    stack:
      "React, Redux, React-Query, Framer-Motion, React-Hook-Form, Styled-Components, Axios",
  ...
  },
  {
    ...
    image: [
      "/assets/my-project/instar1.png",
      "/assets/my-project/instar2.png",
      "/assets/my-project/instar3.png",
      "/assets/my-project/instar4.png",
    ],
    content:
    ...
    stack:
      "React, Redux, React-Query, React-Hook-Form, Styled-Components, Axios",
    deployment: "Vercel",
  },
  {
    id: "6",
