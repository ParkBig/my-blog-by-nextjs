  ...
  const data: ProjectContent[] = [
    {
      ...
      image: ["blog1.png"],
      content: "Next Js를 이용하여 만든 개인 블로그입니다, 프로젝트 포트폴리오 및 포스팅을 싣고있습니다.",
    ...
    },
    {
      ...
      image: ["chess1.png", "chess2.png", "chess3.png", "chess4.png"],
      content: "지인과 체스를 즐길 수 있는 체스 게임입니다. 방이름을 입력하여 생성하거나, 이미 만들어진 방에 입장이 가능합니다. 알람기능을 적용하여 상대방이 입장하거나, 게임 시작, 체스말이 잡힐때, 게임이 끝날때 등 알람을 띄우고 자동으로 사라집니다.  게임중 누구의 차례인지 시각적으로 확인할 수 있습니다.  게임이 종료되면 재매치 혹은 방을 나갈수 있습니다.",
    ...
    },
    {
      ...
      image: ["num1.png", "num2.png"],
      content: "비교를 원하는 데이터를 입력하여 그래프를 통해 시각적으로 결과를 확인할 수 있는 프로그램입니다. 그룹을 이뤄 전체 값을 확인할 수 있고, CSV로 추출이 가능합니다.  PWA를 사용하여 웹앱으로 사용이 가능합니다.",
    ...
    },
    {
      ...
      image: ["moa1.png", "moa2.png", "moa3.png"],
      content: "개인의 일정 관리 및 지인과 실시간으로 채팅을 치며 계획을 작성할 수 있는 일정관리 서비스입니다.  실제로 광고를 하며 배포하여 유저 피드백까지 받아 정정한 팀 프로젝트입니다. 팀 리더를 맡아 FE, BE의 원할한 의사소통을 주재 하였으며, 팀의 전체적인 일정관리 및 기술 적용을 주도하였습니다.",
    ...
    },
    {
      ...
      image: ["instar1.png", "instar2.png", "instar3.png", "instar4.png"],
      content: "Instargram 클론코딩입니다.  FE리더로서 뼈대, 주요기능, 일정 등을 리드했습니다.",
    ...
    },
    {
      ...
      image: ["gall1.png", "gall2.png", "gall3.png"],
      content: "갤러거 게임입니다. Canvas, 생성자 함수, this등을 공부하며 숙련하기 위해 만든 미니게임입니다.",
